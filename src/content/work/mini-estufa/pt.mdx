...
`/api/sensor/latest` existe por causa de uma falha real: um dashboard que abre entre dois broadcasts não tem o que desenhar e mostra um gráfico vazio até a próxima leitura chegar. Um stream ao vivo precisa de um jeito de responder “o que é verdade agora” para quem acabou de chegar.
